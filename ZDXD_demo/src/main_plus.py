...
VLM_MODEL_PATH = os.environ.get("VLM_MODEL_PATH", "TenFate/ZDXD")
...
st.set_page_config(
    page_title="智盾行动-MM-LLM",
    page_icon=":robot:",
    layout="centered",
    initial_sidebar_state="expanded",
)

st.title("智盾行动-MM-LLM")
...
prompt_text = st.chat_input("Chat with ZDXD!", key="chat_input")
